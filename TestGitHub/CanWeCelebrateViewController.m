//
//  CanWeCelebrateViewController.m
//  TestGitHub
//
...
@interface CanWeCelebrateViewController ()

@end

@implementation CanWeCelebrateViewController
...
- (void)viewDidLoad {
    ...
    [lblTitle setText:@"Maze LO View Controller"];
